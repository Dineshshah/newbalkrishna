					...
					<form class="form-horizontal" method="post" action="{{url('/blog-update/'.$blog->id)}}" enctype="multipart/form-data">
						...
						<div class="box-body">
							<div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									<div class="input-group">
										...
										<input type="text" class="form-control" id="inputTourName3" placeholder="Enter Title" name="title" value="{{$blog->title}}">
									</div>
							...
							<div class="form-group {{ $errors->has('altimage') ? 'has-error' : ''}}">
								...
								<div class="col-sm-6">
									<div class="input-group">
										...
										<input type="text" class="form-control" id="altimage" name="altimage" placeholder="" value="{{$blog->altimage}}">
									</div>
							...
							<div class="form-group {{ $errors->has('date') ? 'has-error' : ''}}">
								...
								<div class="col-sm-6">
									<div class="input-group">
										...
										<input type="date" class="form-control" id="date" name="date" placeholder="" value="{{$blog->date}}">
									</div>
									@if ($errors->has('date'))
									<span class="help-block">
							...
							<div class="form-group {{ $errors->has('description') ? 'has-error':''}}">
								...
								<div class="col-sm-6">
									<div class="input-group">
										...
										<textarea class="form-control" rows="5" id="summernote" placeholder="Enter Description" name="description" >{!!$blog->description!!}</textarea>
							...
							<div class="form-group {{ $errors->has('shortdescription') ? 'has-error':''}}">
								...
								<div class="col-sm-6">
									<div class="input-group">
										...
										<textarea class="form-control" rows="5" id="summernote1" placeholder="Enter shortDescription" name="shortdescription">{{$blog->shortdescription}}</textarea>
									</div>
							...
							<div class="form-group  {{ $errors->has('seotitle') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									<div class="input-group">
										...
										<input type="text" class="form-control" id="inputSeoTitle3" placeholder="Enter SEO Title" name="seotitle" value="{{$blog->seotitle}}">
									</div>
							...
							<div class="form-group {{ $errors->has('seokeyword') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									<div class="input-group">
										...
										<input type="text" class="form-control" id="inputSeoKeywords3" placeholder="Enter SEO Keywords" name="seokeyword" value="{{$blog->seokeyword}}">
									</div>
							...
							<div class="form-group {{ $errors->has('seodescription') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									<div class="input-group">
										...
										<textarea class="form-control" rows="5" id="inputSeoDescription3" placeholder="Enter SEO Description" name="seodescription" >{!!$blog->seodescription!!}</textarea>
									</div>
							...
							<div class="form-group {{ $errors->has('active') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									<label>
										<input type="radio"{{$blog->active == '1' ? 'checked' : ''}} name="active" value="1" class="flat-red" checked>Yes
									</label>
									<label>
										<input type="radio"{{$blog->active == '0' ? 'checked' : ''}} name="active" value="0" class="flat-red">No
									</label>
								</div>
