...
@if(Session::has('date'))
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Edit About TimeLine</li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                   <form method="post" class="form-horizontal" action="{{url('/abouts-update-timeline/'.$time->id)}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                        ...
                        <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="inputTourName3" placeholder="Enter Title" name="title" value="{{$time->title}}">
                                    </div>
                            ...
                            <div class="form-group {{ $errors->has('date') ? 'has-error' : ''}}">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        ...
                                        <input type="date" class="form-control" id="startdate" name="date" placeholder="" value="{{$time->date}}">
                                    </div>
                                    @if ($errors->has('date'))
                                    <span class="help-block">
                            ...
                            <div class="form-group {{ $errors->has('summary') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" rows="5" id="summernote" placeholder="Enter Description" name="summary" required="">{!!$time->summary!!}</textarea>
                        ...
                        <div class="box-footer col-md-offset-4">
                            <button type="submit" class="btn btn-info">Update About TimeLine</button>
