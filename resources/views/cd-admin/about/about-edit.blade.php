        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                   <form method="post" class="form-horizontal" action="{{url('/abouts-update/'.$about->id)}}" enctype="multipart/form-data">
                {{ csrf_field() }}
                            ...
                            <div class="form-group {{ $errors->has('altimage') ? 'has-error' : ''}}">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="Altimage" name="altimage" placeholder="" value="{{ $about->altimage}}" required="">
                                    </div>
                            ...
                            <div class="form-group {{ $errors->has('summary') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" rows="5" id="summernote" placeholder="Enter Description" name="summary" required="">{!!$about->summary!!}</textarea>
                            ...
                            <div class="form-group{{ $errors->has('seo_title') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="seo_title" name="seo_title" value="{{ $about->seo_title}}" required="">
                            ...
                            <div class="form-group{{ $errors->has('seo_keyword') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="seo_keyword" name="seo_keyword" value="{{ $about->seo_keyword}}" required="">
                            ...
                            <div class="form-group{{ $errors->has('seo_description') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" rows="5" id="description" placeholder="Enter seo_description" name="seo_description" required="">{{$about->seo_description}}</textarea>
