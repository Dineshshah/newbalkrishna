		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-info">
					...
					<!-- /.box-header -->
					<!-- form start -->
					<form class="form-horizontal" method="post" action="{{url('/events-update/'.$event->id)}}" enctype="multipart/form-data">
						{{csrf_field()}}
						<div class="box-body">
							<div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									<div class="input-group">
										...
										<input type="text" class="form-control" id="inputTourName3" placeholder="Enter Title" name="title" value="{{$event->title}}">
									</div>
							...
							<div class="form-group {{ $errors->has('startdate') ? 'has-error' : ''}}">
								...
								<div class="col-sm-6">
									<div class="input-group">
										...
										<input type="date" class="form-control" id="startdate" name="startdate" placeholder="" value="{{$event->startdate}}">
									</div>
								...
								<div class="col-sm-6">
									<div class="input-group">
										...
										<input type="date" class="form-control" id="enddate" name="enddate" placeholder="" value="{{$event->enddate}}">
									</div>
							...
							<div class="form-group {{ $errors->has('description') ? 'has-error':''}}">
								...
								<div class="col-sm-6">
									<div class="input-group">
										...
										<textarea class="form-control" rows="5" id="summernote" placeholder="Enter Description" name="description" >{!!$event->description!!}</textarea>
							...
							<div class="form-group {{ $errors->has('active') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									<label>
										<input type="radio"{{$event->active == '1' ? 'checked' : ''}} name="active" value="1" class="flat-red" checked>Yes
									</label>
									<label>
										<input type="radio" {{$event->active == '0' ? 'checked' : ''}} name="active" value="0" class="flat-red">No
									</label>
								</div>
