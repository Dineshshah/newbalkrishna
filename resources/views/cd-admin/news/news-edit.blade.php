		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-info">
					...
					<!-- /.box-header -->
					<!-- form start -->
					<form class="form-horizontal" method="post" action="{{url('/news-update/'.$news->id)}}" enctype="multipart/form-data">
						{{csrf_field()}}
						<div class="box-body">
							<div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									<div class="input-group">
										...
										<input type="text" class="form-control" id="inputTourName3" placeholder="Enter Title" name="title" value="{{$news->title}}">
									</div>
							...
							<div class="form-group {{ $errors->has('papername') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									<div class="input-group">
										...
										<input type="text" class="form-control" id="inputTourName3" placeholder="Enter Paper Name" name="papername" value="{{$news->papername}}">
									</div>
							...
							<div class="form-group {{ $errors->has('link') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									<div class="input-group">
										...
										<input type="text" class="form-control" id="inputTourName3" placeholder="Enter Link" name="link" value="{{$news->link}}">
									</div>
									@if ($errors->has('link'))
									<span class="help-block">
							...
							<div class="form-group {{ $errors->has('shortdescription') ? 'has-error':''}}">
								...
								<div class="col-sm-6">
									<div class="input-group">
										...
										<textarea class="form-control" rows="5" id="summernote1" placeholder="Enter shortDescription" name="shortdescription">{{$news->shortdescription}}</textarea>
									</div>
							...
							<div class="form-group {{ $errors->has('active') ? ' has-error' : '' }}">
								...
								<div class="col-sm-6">
									<label>
										<input type="radio"{{$news->active == '1' ? 'checked' : ''}} name="active" value="1" class="flat-red" checked>Yes
									</label>
									<label>
										<input type="radio"{{$news->active == '0' ? 'checked' : ''}} name="active" value="0" class="flat-red">No
									</label>
								</div>
